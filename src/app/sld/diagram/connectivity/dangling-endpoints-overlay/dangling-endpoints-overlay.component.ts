...
import { findDanglingEndpoints, SNAP_TO_DANGLING_PX } from '../dangling-endpoints';
...
export class DanglingEndpointsOverlayComponent {
  ...
  // Defensively gated on isLinking() — sketch mode shouldn't fire linking but if it does we hide the overlay.
  protected readonly visible = computed(() => {
    if (!this.modeService.isLinking()) return false;
