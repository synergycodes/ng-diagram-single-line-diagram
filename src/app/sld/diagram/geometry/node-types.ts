...
// Matches `JUNCTION_DOT_SIZE_PX * 2` so a junction dot sits on the centreline.
export const WIRE_THICKNESS_PX = 16;

export const WIRE_DEFAULT_LENGTH_PX = 64;

// Type guards: narrow a generic Node to its SLD data contract by the `type`
...
// wire-endpoint math shared by connectivity, the connected-component BFS, and
// wire-snap (previously duplicated byte-for-byte across all three).
