...
// Shared spatial-hash primitives for the connectivity graph: bucketed lookups
// that replace linear scans. Connection geometry is grid-aligned, so rounding
// groups coincident points (within POSITION_TOLERANCE_PX) into one bucket.
