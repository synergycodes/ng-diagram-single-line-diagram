...
// Floating editor for the single selected symbol: renders a Formly form from the
// symbol's property schema and writes edits straight back to the diagram model.
// Collapses out of view when the selection isn't a single symbol node.
@Component({
  selector: 'app-properties-panel',
  imports: [ReactiveFormsModule, FormlyForm, IconComponent],
